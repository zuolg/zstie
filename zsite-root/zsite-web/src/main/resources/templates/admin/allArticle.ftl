	    ...
	    <section class="content">
			...
			<div class="row content-row">
				<ul class="list-inline" style="float: left">
					<li class="all">
						<a class="current" href="/jpress/admin/content?m=article&amp;p=article&amp;c=list">
							全部 <span class="count">(0)</span>
						</a>
						|
					</li>
					<li class="publish">
						<a href="/jpress/admin/content?m=article&amp;p=article&amp;c=list&amp;s=normal">
							已发布 <span class="count">(0)</span>
						</a>
						|
					</li>
					<li class="publish">
						<a href="/jpress/admin/content?m=article&amp;p=article&amp;c=list&amp;s=draft">
							草稿 <span class="count">(0)</span>
						</a>
						|
					</li>
					<li class="trash">
						<a href="/jpress/admin/content?m=article&amp;p=article&amp;c=list&amp;s=delete">
				...
				<form class="form-horizontal" method="POST" style="float: right" action="/jpress/admin/content?m=article&amp;p=article&amp;c=list&amp;s=&amp;tids=">
			...
			<div class="row content-row">
				...
				<div class="jp-left  ">
					...
					<input class="tids" name="tids" type="hidden">
					<input class="btn btn-block btn-sm btn-default" value="筛选" type="submit">
					</form>
				</div>
			</div>
