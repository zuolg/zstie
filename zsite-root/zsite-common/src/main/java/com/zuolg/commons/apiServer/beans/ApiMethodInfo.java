...
public class ApiMethodInfo implements Comparable<ApiMethodInfo> {
	...
	/**
	 * 检查登录情况，该方法需要用到的 ILoginContext 需要从外部注入。所有可用在 invoke前仔细
	 * 
	 * @see AjaxAdapter#onBeforeInvoke
	 * 
	 * @param context
	 *            已登录用户的查询接口
	 ...
	 *//*
	public void checkRightUseLoginCheck(IWebUserProvider context) throws InvalidLoginStatusException {
