...
public class ContentRepositoryImpl {
	...
	@Autowired
	private QueryRepository<BaseContent> queryRepository;

	public QueryRepository<BaseContent> getQueryRepository() {
		return queryRepository;
	}

	public void setQueryRepository(QueryRepository<BaseContent> queryRepository) {
